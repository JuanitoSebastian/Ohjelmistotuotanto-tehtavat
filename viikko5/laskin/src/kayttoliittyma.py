...
class Kayttoliittyma:
    def __init__(self, sovelluslogiikka, root):
        ...
        self._kommenot = {
            ...
            Komento.KUMOA: Kumoa(self._sovelluslogiikka, self._lue_syote, self._aiemmat_tulokset)
        }
    ...
    def _suorita_komento(self, komento):
        self._ota_aiempi_tulos_talteen(komento)
    ...
    def _ota_aiempi_tulos_talteen(self, komento):
        if komento != Komento.KUMOA:
            self._aiemmat_tulokset.append(self._sovelluslogiikka.tulos)